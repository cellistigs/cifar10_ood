...
class CINIC10_Data(pl.LightningDataModule):
    ...
    def val_dataloader(self):
        ...
        dataset = CINIC_10(root_dir=self.hparams.data_dir, split="val", transform=transform,version = self.version)
    ...
    def test_dataloader(self):
        ...
        dataset = CINIC_10(root_dir=self.hparams.data_dir, split="test", transform=transform,version = self.version)
        dataloader = DataLoader(
            dataset,
            batch_size=self.hparams.batch_size,
            num_workers=self.hparams.num_workers,
